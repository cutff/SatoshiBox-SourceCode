...
<div class="container" id="main-container">
        ...
        <div class="col-lg-12">
            <a href="/"><h1 class="logo"><img src="assets/img/logo.png" width="48px"> Satoshi Box</h1></a>
        </div>
    </div>
...
<ul>
    ...
    <li>We payout 99% <strong>instantly</strong> to your btc address (except bitcoin transfer fees)</li>
