<?php
	...
	if(isset($_GET["product"])) {
		...
		$title = "SatoshiBox ~ Buy This Product";
	}
	...
	if($receive_addr == 1) {
		$status = 1;
		$title = "SatoshiBox ~ Bought Product";
		...
		$title = "SatoshiBox ~ Waiting Payment ...";
	}
	}
...
<body>
<div class="alert alert-info"><center><strong><a href="mailto:info@progweb.info" style="color:red">contact us from here</a></strong>.
<?php
if(isset($_GET["product"])) {
?>
<br>
